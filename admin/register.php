...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `register`(`first_name`,`last_name`,`email`,`password`,`re_password`)
        VALUES ('$frist_name',' $last_name',' $email','$password','$re_password')";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" class="user" action="register.php">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="re_password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Repeat Password">
                                    </div>
                                </div>
